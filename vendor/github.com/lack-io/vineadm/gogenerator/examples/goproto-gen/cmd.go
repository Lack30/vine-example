...
import (
	...
	"github.com/lack-io/vineadm/gogenerator/args"
	"github.com/lack-io/vineadm/gogenerator/generator"
	"github.com/lack-io/vineadm/gogenerator/namer"
	"github.com/lack-io/vineadm/gogenerator/parser"
	"github.com/lack-io/vineadm/gogenerator/types"
	utilbuild "github.com/lack-io/vineadm/util/build"
	"github.com/lack-io/vineadm/util/log"
)
...
func New() *Generator {
	...
	return &Generator{
		...
		Packages:           "",
		DropEmbeddedFields: "github.com/lack-io/vineadm/internal/meta/v1.TypeMeta",
	}
}
...
func (g *Generator) BindFlags(app *ccli.App) {
	...
	app.StringSliceVar(&g.ProtoImport, "proto-import", g.ProtoImport,
		"The search path for the core protobuf .protos, required; defaults $GOPATH/src/github.com/lack-io/vineadm/vendor/github.com/gogo/protobuf/gogoproto.", "")
