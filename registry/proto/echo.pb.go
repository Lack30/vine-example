...
// source: github.com/lack-io/vine-example/registry/proto/echo.proto
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_9b62c04a1a856ef6, []int{0}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_9b62c04a1a856ef6, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/lack-io/vine-example/registry/proto/echo.proto", fileDescriptor_9b62c04a1a856ef6)
}

var fileDescriptor_9b62c04a1a856ef6 = []byte{
	...
	,
}
...
func (c *echoClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/Echo/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedEchoServer) Call(ctx context.Context, req *Request) (*Response, error) {
...
var _Echo_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/lack-io/vine-example/registry/proto/echo.proto",
}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Reply) > 0 {
		i -= len(m.Reply)
		copy(dAtA[i:], m.Reply)
		i = encodeVarintEcho(dAtA, i, uint64(len(m.Reply)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
